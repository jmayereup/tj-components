import { a as k } from "./chunks/audio-utils-BwH2sOvH.js";
import { c as j } from "./chunks/tj-config-BapMvaer.js";
...
class f extends HTMLElement {
  ...
  constructor() {
    var o;
    super(), this.attachShadow({ mode: "open" }), this.synth = window.speechSynthesis, this.currentUtterance = null, this.currentButtonId = null, this.isTextSwapped = !1, this.studentInfo = { nickname: "", number: "", homeroom: "", teacherCode: "" }, this.submissionUrl = ((o = j) == null ? void 0 : o.submissionUrl) || "https://script.google.com/macros/s/AKfycbzqV42jFksBwJ_3jFhYq4o_d6o7Y63K_1oA4oZ1UeWp-M4y3F25r0xQ-Kk1n8F1uG1Q/exec", this.isSubmitting = !1, this.ttsState = {
      status: "idle",
      activeButtonId: null,
  ...
  renderChapter(t, o) {
    ...
    if (this.shouldShowAudioControls())
      ...
      if (m) {
        ...
        v = `<div style="margin-top: 0.5em;"><a href="${`intent://${w}#Intent;scheme=${x};package=com.android.chrome;end`}" style="color: var(--tj-accent-color); text-decoration: underline; font-weight: bold;">Open in Chrome</a></div>`;
      }
      g = `
