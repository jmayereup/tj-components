...
import { c as z } from "./chunks/tj-config-JtFGQ6Kt.js";
...
`, l = class l extends HTMLElement {
  constructor() {
    var t;
    super(), this.attachShadow({ mode: "open" }), this.lessonData = null, this.currentPhase = 0, this.score = 0, this.answeredCount = 0, this.totalQuestions = 0, this.isCompleted = !1, this.studentInfo = { nickname: "", number: "", homeroom: "", teacherCode: "" }, this.submissionUrl = (t = z) == null ? void 0 : t.submissionUrl, this.isSubmitting = !1, this.selectedVoiceName = null, this.isPlaying = !1, this._currentAudioEl = null;
