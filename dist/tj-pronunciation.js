...
class H extends HTMLElement {
  ...
  render(e) {
    ...
    t.innerHTML = `<style>${P}</style><style>${V}</style>${O}`, this.shadowRoot.firstChild && (this.shadowRoot.innerHTML = ""), this.shadowRoot.appendChild(t.content.cloneNode(!0)), e.title && (this.shadowRoot.getElementById("pronunciationTitle").textContent = e.title);
    let o = "";
