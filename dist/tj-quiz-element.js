import { c as A } from "./chunks/tj-config-DtZWnqEi.js";
...
class Q extends HTMLElement {
  ...
  get code() {
    return this.getAttribute("code") !== null ? this.getAttribute("code") : A.teacherCode;
  }
  set code(e) {
...
`);
  ...
  showFinalScore(e = !0) {
    ...
    if (k && !this.testMode && (C = `
                ...
                <div class="written-answers-section">
                    ...
                    ${S.map((y, z) => {
      const I = this.currentQuestions.indexOf(y), E = this.userQuestionAnswers[I] || "-";
      return `
  ...
  getWrittenAnswersString() {
    ...
    return e.length === 0 ? "" : e.map((t, o) => {
      const s = this.currentQuestions.indexOf(t), a = this.userQuestionAnswers[s] || "";
      return `Q: ${t.q}
A: ${a}`;
    }).join(`
...
customElements.define("tj-quiz-element", Q);
