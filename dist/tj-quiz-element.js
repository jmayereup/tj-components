import { c as A } from "./chunks/tj-config-BapMvaer.js";
...
`).trim();
  ...
  setupEventListeners() {
    ...
    e && (e.addEventListener("change", (i) => {
      ...
      this.handleClozeAnswer(i), this.handleVocabAnswer(i), this.handleShortAnswer(i), i.target.classList.contains("short-answer-input") && i.target.tagName.toLowerCase() === "textarea" && this.autoExpandTextarea(i.target);
...
`);
    ...
    for (let n = 0; n < this.totalQuestions; n++) {
      ...
      if (a !== void 0) {
        ...
        if (l.o && l.o.length > 0) {
          ...
          const c = this.shadowRoot.querySelector(`.short-answer-input[name="${i}"]`);
  ...
  showQuestionFeedback() {
    ...
    for (let e = 0; e < this.totalQuestions; e++) {
      ...
      if (!t.o || t.o.length === 0) {
        const i = this.shadowRoot.querySelector(`.short-answer-input[name="${o}"]`);
