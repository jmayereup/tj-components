...
class R extends HTMLElement {
  ...
  constructor() {
    ...
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = `
      <style>${I}</style>
      ${M}
    `, this.data = [], this.studentInfo = { nickname: "", number: "", homeroom: "", teacherCode: "" }, this.submissionUrl = (t = L) == null ? void 0 : t.submissionUrl, this.isSubmitting = !1, this.score = 0, this.answeredCount = 0, this.isPlayingAll = !1, this.playbackIndex = 0, this.isPaused = !1, this.playbackUtterance = null;
