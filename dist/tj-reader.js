import { c as j } from "./chunks/tj-config-DtZWnqEi.js";
...
class R extends HTMLElement {
  get code() {
    return this.getAttribute("code") !== null ? this.getAttribute("code") : j.teacherCode;
  }
  set code(e) {
  ...
  constructor() {
    ...
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = `
      <style>${I}</style>
      ${M}
    `, this.data = [], this.studentInfo = { nickname: "", number: "", homeroom: "", teacherCode: "" }, this.submissionUrl = (t = j) == null ? void 0 : t.submissionUrl, this.isSubmitting = !1, this.score = 0, this.answeredCount = 0, this.isPlayingAll = !1, this.playbackIndex = 0, this.isPaused = !1, this.playbackUtterance = null;
  ...
  generateReport() {
    ...
    const h = i * b + c * m + d * y, p = this.shadowRoot.querySelector(".report-area"), l = h >= 80 ? "🏆" : h >= 50 ? "⭐" : "💪", u = h >= 80 ? "Excellent!" : h >= 50 ? "Good effort!" : "Keep practicing!";
    if (p.innerHTML = `
      <div class="rc-header">
