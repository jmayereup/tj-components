import { c as R } from "./chunks/tj-config-BapMvaer.js";
import { a as z, b as P, s as T, g as M } from "./chunks/audio-utils-BwH2sOvH.js";
...
class j extends HTMLElement {
  ...
  constructor() {
    ...
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = `
      <style>${I}</style>
      ${A}
    `, this.data = [], this.studentInfo = { nickname: "", number: "", homeroom: "", teacherCode: "" }, this.submissionUrl = ((t = R) == null ? void 0 : t.submissionUrl) || "https://script.google.com/macros/s/AKfycbzqV42jFksBwJ_3jFhYq4o_d6o7Y63K_1oA4oZ1UeWp-M4y3F25r0xQ-Kk1n8F1uG1Q/exec", this.isSubmitting = !1, this.score = 0, this.answeredCount = 0, this.isPlayingAll = !1, this.playbackIndex = 0, this.isPaused = !1, this.playbackUtterance = null;
